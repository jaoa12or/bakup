           ...
           <?php if (have_posts()) : while (have_posts()) : the_post();?><!--pregunta a wordpres si hay post y si hay lo ejecuta -->
            ...
            <article>
                  <div class="thumb"><a href="<?php the_permalink();?>">
                   ...
                   <hgroup>
                       <h2><a href=""><?php  the_title(); ?></a></h2><!--permalink sirve para agregr el dinmismo en los links ; the_title sirve para agragar el título a nuestros articulos de manera dinámica -->
                   </hgroup>
